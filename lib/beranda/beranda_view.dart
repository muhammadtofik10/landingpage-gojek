...
import 'package:landing_page_gojek/beranda/beranda_gojek_appbar.dart';
import 'package:landing_page_gojek/beranda/beranda_model.dart';
import 'dart:async';
import 'dart:io';
...
class _BerandaPageState extends State<BerandaPage> {
  ...
  Future<List<Promo>> fetchPromo() async {
    ...
    _poromoList.add(new Promo(
        ...
        button: "LAKSANAKAN"));
    return new Future.delayed(new Duration(seconds: 13), () {
      return _poromoList;
    });
  }
}
